...
import com.codewithanurag.blog.Entity.Post;
...
import com.codewithanurag.blog.repository.PostRepo;
...
public class PostServiceImpl implements PostService {
	...
	com.codewithanurag.blog.Entity.User user =	this.userRepo.findById(userId).orElseThrow(()->new ResourceNotFoundException("User", "User Id", userId));
   ...
   Post newPost = this.postRepo.save(post);
	...
	@Override
	public List<PostDto> searchPosts(String keyord) {
	List<Post> posts = this.postRepo.searchByTitle("%"+keyord+"%");
